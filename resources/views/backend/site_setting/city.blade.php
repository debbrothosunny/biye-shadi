        ...
        <div class="card-body">
            <ul class="navbar-nav d-inline mb-3">
                <li class="nav-item col-lg-3 float-right mb-3 mt-2 d-none" style="padding-right: 4.3%;">
                    <a class="nav-link btn btn-info create-new-button px-3">City</a>
                </li>
                            ...
                            <div class="modal-dialog" style="max-width:1000px !important;">
                                <div class="modal-content ">
                                    ...
                                    <div class="modal-body" style="color: #cab562;">
                                        <form class="forms-sample" action="{{ route('city.update', $postData->id) }}"
                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="modal-footer">
                                        ...
                                        <a type="button" class="btn btn-danger"
                                            href="{{ route('city.delete', $postData->id) }}">Delete</a>
                                    </div>
                                </div>
                            </div>
                        </div>
...
<div class="modal fade most_resent" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel"
    ...
    <div class="modal-dialog" style="max-width:1000px !important;">
        <div class="modal-content ">
            ...
            <div class="modal-body" style="color: #cab562;">
                <form class="forms-sample" action="{{ route('city.create') }}" method="POST"
                    ...
                    <div class="row ml-2">
                        <div class="col-md-4 ">
                            <div class="form-group row">
                                <label style="color:#c6b6b6;">City &nbsp; &nbsp; &nbsp; </label>
                                <input style="width:90%;" type="text" class="form-control p-1" name="city"
                                    value="{{ old('city') }}" placeholder="Country">
                                <span class="text-danger">
                                    @error('city')
                                    {{ $message }}
                                    @enderror
